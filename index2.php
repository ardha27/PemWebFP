...
<head>
  ...
  <!-- Google Fonts -->
  <link href="<?=BASE_URL;?>https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
  ...
  <link href="<?=BASE_URL;?>assets2/vendor/owl.carousel/assets2/owl.carousel.min.css" rel="stylesheet">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="<?=BASE_URL;?>assets2/img/menu/lobster-bisque.jpg" class="menu-img" alt="">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="<?=BASE_URL;?>assets2/img/menu/bread-barrel.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="<?=BASE_URL;?>assets2/img/menu/cake.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="<?=BASE_URL;?>assets2/img/menu/caesar.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="<?=BASE_URL;?>assets2/img/menu/tuscan-grilled.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <img src="<?=BASE_URL;?>assets2/img/menu/mozzarella.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="<?=BASE_URL;?>assets2/img/menu/greek-salad.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <img src="<?=BASE_URL;?>assets2/img/menu/spinach-salad.jpg" class="menu-img" alt="">
            <div class="menu-content">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="<?=BASE_URL;?>assets2/img/menu/lobster-roll.jpg" class="menu-img" alt="">
            <div class="menu-content">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="owl-carousel events-carousel" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="row event-item">
            <div class="col-lg-6">
              <img src="<?=BASE_URL;?>assets2/img/event-birthday.jpg" class="img-fluid" alt="">
            </div>
          ...
          <div class="row event-item">
            <div class="col-lg-6">
              <img src="<?=BASE_URL;?>assets2/img/event-private.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0 content">
          ...
          <div class="row event-item">
            <div class="col-lg-6">
              <img src="<?=BASE_URL;?>assets2/img/event-custom.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0 content">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              <img src="<?=BASE_URL;?>assets2/img/chefs/chefs-1.jpg" class="img-fluid" alt="">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              <img src="<?=BASE_URL;?>assets2/img/chefs/chefs-2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sarah Jhonson</h4>
                  <span>Patissier</span>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="300">
              <img src="<?=BASE_URL;?>assets2/img/chefs/chefs-3.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
